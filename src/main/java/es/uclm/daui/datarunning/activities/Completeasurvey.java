...
public class Completeasurvey extends AppCompatActivity {
...
setContentView(R.layout.activity_completeasurvey);
}
...
void onClickShowracesurvey(View v) {
 Intent intentNavigate = new Intent(this, Showracesurvey.class);
 startActivity(intentNavigate);
}
@Override
public boolean onCreateOptionsMenu(Menu menu) {
// Inflate the menu; this adds items to the action bar if it is present.
getMenuInflater().inflate(R.menu.menu_completeasurvey, menu);
return true;
}
