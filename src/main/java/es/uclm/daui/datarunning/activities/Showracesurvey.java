...
public class Showracesurvey extends AppCompatActivity {
...
setContentView(R.layout.activity_showracesurvey);
}
...
getMenuInflater().inflate(R.menu.menu_showracesurvey, menu);
return true;
}
